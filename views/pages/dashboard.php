...
.pic:hover img {
 ...
 <section class="content-header bg-light shadow-lg p-3 mb-3 bg-body rounded">
 ...
 <div class="row">
   <div class="col-lg-3 col-4">
     ...
     <div class="small-box bg-info">
       <div class="inner">
        <?php 
        $result =Order::count("where order_date=CURDATE()");
		    
        ?>
         <h3><?php echo $result?></h3>
         <div class="pic">
         <img src="img/pizza.jpg" alt="" style="width:100%;height:100%;">
         </div>
         <p>New Orders</p>
       </div>
   ...
   <div class="col-lg-3 col-4">
     ...
     <div class="small-box bg-success">
       <div class="inner">
         ...
         <div class="pic">
         <img src="img/burger2.jpg" alt="" style="width:90%;height:90%;">
        </div>
         <p>New Product</p>
       </div>
   ...
   <div class="col-lg-3 col-4">
     ...
     <div class="small-box bg-warning">
       <div class="inner">
         ...
         <div class="pic">
         <img src="img/Untitled-1.jpg" alt="" style="width:100%;height:100%;">
        </div>
         <p>New Offer</p>
       </div>
       <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
   ...
   <div class="col-lg-3 col-4">
     ...
     <div class="small-box bg-danger">
       <div class="inner">
         <h3>450</h3>
         <div class="pic">
         <img src="img/Untitled-2.jpg" alt="" style="width:100%;height:100%;">
        </div>
         <p>Most Populer Item</p>
       </div>
       <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
     </div>
   </div>
