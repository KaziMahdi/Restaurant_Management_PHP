            ...
            <div class="col-sm-3 invoice-col">
              ...
              <table>
                ...
                <tr>
                  ...
                  <td><input type="text" id="txtOrderDate" value=<?php echo date("d-m-Y"); ?> style="width:96px ;" /></td>
                </tr>
                <tr>
                  <td><b>Due Date:</b></td>
                  <td><input type="text" id="txtDueDate" value=<?php echo date("d-m-Y"); ?> style="width:96px ;" /></td>
                </tr>
              </table>
            </div>
            <!-- /.col -->
...
<script>
  $(function() {
    ...
    //Show customer other information
    $("#cmbMenu").on("change", function() {

      $.ajax({
        url: 'api/menuapi/find',
        type: 'GET',
        data: {
          "id": $(this).val()
        },
